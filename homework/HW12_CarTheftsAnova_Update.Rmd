...
The mean theft rate in the pre-spike time period was 23.1 and that number rose to 59.9 during the spike year. But, during the post-strike period the number dropped to 43.3 but didn't return to the pre-spike number. These results suggest that thefts tripled during the spike year, but after the thefts didn't gi back down to the mean for the pre-spike.
...
The chart displays a more visual representation of the spike in car thefts and how quickly the numbers rose. It is evident that the drop hasn't been enough to get back to the numbers before the spike. The spike year stands out in the chart and it helps to paint a clearer picture of just how much car thefts really went up by, which was a lot.

Car thefts nearly triple during Spike Year in 2023, yet to get back to Pre-Spike Numbers
...
- **Null Hypothesis (H0)**:  There will be no difference in the mean theft rates between the three time periods.

- **Alternative Hypothesis (H1)**: There will be a difference in mean car theft rates amongst one of the three time periods.
...
There is an evident difference in the average rates between the time periods. I believe all three time had distinct results. With an F-value of 218 and a really small p-value of <2e-16, we must reject the null hypothesis. There was definitely a significant difference between the pre-spike, spike year and post-spike. Car theft rates were much higher during the spike year and since then they have remained elevated, and it is definitely due to random chance.
...
Spike in Car thefts yet to return to Pre-Spike Numbers

The results of the Turkey's test proved that car thefts were much higher during the spike year than the pre-spike time period. After the spike year, (post-spike) it is clear that car thefts have remained high and have not gotten back to the number they used to be. The bar chart helps highlight just how different each time period is from each other, proving that they are statistically significant from each other. But, the numbers have yet to drop back down to where they used to be, unsure when pre-spike numbers wll return.