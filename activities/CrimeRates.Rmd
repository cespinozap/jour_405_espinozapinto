...
crimes <- read_csv("https://raw.githubusercontent.com/dwillis/jour405/main/data/md_annual_crime.csv") |>
  clean_names()
...
I found that crime was gradually going up throughout the years, but then it dropped back down. 2020 was the year with the lowest crime rate and 1980 was the year with the highest crime rate. This data does not match my expectations because I feel like we live in such a violent society now, it's surprising to see it's always been violent, even in the 80s.
