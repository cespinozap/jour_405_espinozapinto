...
md_cities_percentiles <- md_cities_change %>%
  mutate(violent_2020_percentile = ntile(violent_rate_2020, 100))

cities_above_90 <- md_cities_percentiles %>%
...
The results are different than what I expected but because there are certain cities that still stick out in the data and they coincide with the highest crime rates. But, it takes away all the attention on Baltimore and it's high number of crimes. I would change my best story idea to not just focus on Baltimore, but other cities in the 90th percentile.