...
My initial reaction to the change in car thefts was that there had been a lot of fluctuation between the months. Recently there has been a drop of car thefts and the trend has stayed down. This shows improvement in car thefts because the thefts haven't gone back to how high it once was.
...
- What does the 95% confidence interval show here? The 95% confidence interval represents where on the data the average number of car thefts lie. There's a 95% chance that the average lies between the lowest and highest number on the chart.

- What figure(s) accurately reflects the number of car thefts in a typical month? 
The average number of car thefts reflects the number of car thefts in a typical month. However, some months may be higher and lower than the average. 
...
Average Car Thefts in Prince George's County drop in recent months
...
The difference between the two period is not statistically significant because there isn't certainty that car thefts won't just continue to flunctuate. A p-value of 0.179 tells us that we can't reject the null hypothesis because there isn't any concrete evidence that can back up the sudden drop in car thefts.
...
Drop in Car Thefts in Prince George's County, data shows drop is not statistically significant
I would tell my editor that eventhough car thefts have stayed down in recent months that there's no real evidence of a trend or something that led to car thefts dropping. I would expect my editor to want to see the data.
