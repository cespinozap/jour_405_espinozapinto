...
It is not statistifically jsutified for the first two poll scenarios because the margin of error could be lower than 50%. For the third scenario, it is possible that the majority supports it.

Poll results Show City Leaning Towards Supporting New City Policy
...
Local official's claim that the impact of the transit line has caused home prices to rise. New data reveals that homes in the transit line's affinity have gone up by at least $20,000. It is unclear whether or not the transit line is the only factor causing the spike in prices at this time.
