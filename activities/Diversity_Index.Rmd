...
At first glance the cites that stand out to me as diverse are Baltimore and Gaithersburg because the raw numbers don't give the impression that one race makes up most of the population. These cities have their numbers more spread out, in comparison to a city like Cumberland who's population is mainly dominated by White residents.
...
The city with the highest race probability is Summerfield since the population is mainly made up of Black residents, it's more likely that two people randomly chosen will be Black than any other race. Black residents make up 93% of the population. More diverse cities, like Gaithersburg have a low race probability because one race does not make up a large majority of the population.
...
The cities with the lowest hispanic probability scores are the cities that have high hispanic populations. These cities are not entirely made up by hispanic residents, but more than half of the population are hispanic. These cities include Chillum, East Riverdale and Wheaton which means that you're more likley to run into a Hispanic resident here than you are in other cities that don't have a large Hispanic population.
...
The cities with the most diversity are Langley Park, Wheaton and Adelphi. These cities are located nearby in Montgomery County and Prince George's County. These cities have a diverse population made up of more than one race. These cities are considered diverse because there are many races that make up the population. The city with the least diversity would be Lake Shore which is in Anne Arundel County. White people make up 93% of the population. There is a 93% chance that you will run into a White resident here, leaving 7% to other races, which is not a representation of diversity.
...
The Most Diverse and Least Diverse Cities To Live in Maryland

Maryland's population is made up of many races, but there are some cities that stand out as the most diverse. On the contrary, there are some cities that are made up of more than 90% of a singular racial group. The cities that stand out as the most diverse are Langley Park, Wheaton and Adelphi with a diverse number of White, Black, Asian and Hispanic residents. 

Switching to the least diverse, cities such as Lake Shore and Summerfield are primarily made up of one racial group. 93% of Lake Shore's population is made up of White residents and 93% of Summerfield's population is made up of Black residents. These are some of the many cities in Maryland in which diversity is not clearly distributed between racial groups.