...
gdp_djia |> 
  ...
  geom_smooth(method = "lm", se = FALSE, color = "tan") +
  labs(
    title = "Relationship Between U.S. GDP and DJIA (2013–2024)",
    x = "Gross Domestic Product (GDP, in trillions USD)",
...
There is a strong relationship between the DJIA and GDP. The points are all going upwards on the graph, as the GDP rose, the GJIA also rose in variety. After the pandemic, the numbers were drastically different and the DJIA was much higher. The GDP and the DJIA are not as close as they were. They both have a strong relationship and the scatterplot gives you a direct visual of how both values rise together. 
