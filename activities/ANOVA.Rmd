...
There are clear differences in SAT scores between types of colleges. Students in private colleges performed with the highest average SAT scores. Public colleges had the second highest average SAT scores. Community colleges have lower average SAT scores and student's scores varied more in comparison to the rest of the data. These differences gives the impression that college type has an effect on the performances of students on the SAT.
...
There is a significant difference in SAT scores across college types because there is a huge f-value of 284.3 and extremely small p-values between college types. This means that the differences in scores are statiscally significant and not random. 

2. Which specific college types differ from each other?

Private colleges scored higher than public colleges, by 74 points. Public colleges scored higher than community colleges, by 293 points. Private colleges scored better than community colleges, by 367 points.

3. How large are these differences?

The difference between scores in private colleges versus community colleges is the largest difference of scores. A 367 point difference is a large difference for an SAT score range of 400-1600. 293 points is also not far from 367, showing a large different in score ranges. The least difference was 74, but that also shows a large gap.
...
New data shows that Private Colleges tend to have students with the highest SAT scores

A test performed on all three college types (Public, Private or Community) found that the students in private colleges scored higher on their SAT scores than any of the other college types. Between private and public colleges, private college students scored 74 points higher. But compared to community colleges, private colleges scored 367 points higher on average. This gives the impression that students at private colleges have better preparation and in result have better test scores. 