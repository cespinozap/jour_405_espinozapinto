...
Two examples of data that might not be normally distributed is consumption of an item or vehicle ownership. If I were to ask a group of people if they drink tea, it would be an all or nothing scenario, we wouldn't have much data to go off of, there wouldn't be as much of a scatter of data. Similarly, if I asked a group of people, specifically college students how many cars they've owned, most of the data is going to be between 0, 1, maybe even 2 but that isn't a good range to draw data from. 

A reporter working on a story about data that isn't normally distributed should try to display data in percentage form or even visual form because seeing a lot of repetition in data tends to sway people away from the data because there are no trends in the data. If a reporter were to survey college students and their drinking tea habits, percentages would be more appealing than actual numbers. As a reporter, you should strive towards making your data look appealing to your audience.
...
Maryland has a high percentile and it's almost identical to Creighton. Comparing it to the highest percentile, it's not far from it but all of the other teams around Maryland have almost identical results. 
...
The distribution is skewed because majority of the data lies on the right side of the histogram. There isn't an even distribution between the data and majority of the data lies after the mean. 
